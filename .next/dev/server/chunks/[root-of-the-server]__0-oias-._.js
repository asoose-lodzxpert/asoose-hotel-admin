...
"[project]/app/api/properties/[propertyId]/room-types/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
        ...
        if (!payload.name || payload.pricePerNight < 0 || payload.quantity < 1 || payload.maxGuests < 1) return Response.json({
            success: false,
            message: "Complete all required room fields."
        }, {
            status: 400
        });
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiBaseUrl"]) {
            const room = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$demo$2d$properties$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createDemoRoom"])(propertyId, payload);
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["forwardJson"])(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["upstream"])(`/api/v1/property-owners/me/properties/${encodeURIComponent(propertyId)}/room-types`, {
            method: "POST",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0-oias-._.js.map