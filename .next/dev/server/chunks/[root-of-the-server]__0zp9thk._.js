...
"[project]/app/api/bookings/[bookingId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, { params }) {
    try {
        ...
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiBaseUrl"]) {
            const booking = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$demo$2d$bookings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["demoBookingStore"].bookings.find((item)=>item.id === bookingId);
            return booking ? Response.json({
                success: true,
                message: "Preview booking",
                data: booking
            }) : Response.json({
                success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0zp9thk._.js.map