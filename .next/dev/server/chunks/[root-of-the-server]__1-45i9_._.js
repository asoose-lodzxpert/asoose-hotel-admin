...
async function GET() {
    try {
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiBaseUrl"]) return Response.json({
            ...
            data: {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$demo$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["demoDashboard"],
                totalProperties: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$demo$2d$properties$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["demoStore"].properties.length,
                publishedProperties: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$demo$2d$properties$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["demoStore"].properties.filter((property)=>property.status === "PUBLISHED").length,
                upcomingCheckIns: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$demo$2d$bookings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["demoBookingStore"].bookings.filter((booking)=>booking.status !== "CHECKED_IN" && booking.status !== "CHECKED_OUT" && booking.status !== "CANCELLED").length,
                currentGuests: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$demo$2d$bookings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["demoBookingStore"].bookings.filter((booking)=>booking.status === "CHECKED_IN").reduce((total, booking)=>total + booking.guests, 0)
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1-45i9_._.js.map