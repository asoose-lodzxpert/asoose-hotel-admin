...
"[project]/app/api/properties/[propertyId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, { params }) {
    try {
        ...
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiBaseUrl"]) {
            const property = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$demo$2d$properties$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["demoStore"].properties.find((item)=>item.id === propertyId);
            return property ? Response.json({
                success: true,
                message: "Preview property",
                data: property
            }) : Response.json({
                success: false,
...
async function PATCH(request, { params }) {
    try {
        ...
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiBaseUrl"]) {
            const property = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$demo$2d$properties$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateDemoProperty"])(propertyId, payload);
            return property ? Response.json({
                success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1gzui7i._.js.map