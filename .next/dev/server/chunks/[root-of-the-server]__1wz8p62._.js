...
async function POST(request) {
    try {
        ...
        if (!file.type.startsWith("image/")) return Response.json({
            success: false,
            message: "Only image uploads are supported here."
        }, {
            status: 400
        });
        if (file.size > 10 * 1024 * 1024) return Response.json({
            success: false,
        ...
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiBaseUrl"]) {
            ...
            return Response.json({
                success: true,
                message: "Preview upload complete",
                data: {
                    url: `data:${file.type};base64,${bytes}`
                }
            });
        }
        const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAccessToken"])();
        ...
        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiBaseUrl"]}/api/v1/uploads?category=general`, {
            method: "POST",
            headers: {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["forwardJson"])(response);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1wz8p62._.js.map