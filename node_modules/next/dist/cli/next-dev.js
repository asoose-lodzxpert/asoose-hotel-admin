...
const nextDev = async (options, portSource, directory)=>{
    ...
    /* custom-patch-cn2-start *//*00001*/let effectiveDistDir = undefined; try { if (typeof distDir === 'undefined') { const loadConfig = require('../server/config').default; const { PHASE_DEVELOPMENT_SERVER } = require('../shared/lib/constants'); let hasConfigBinding = true; try { config; } catch { hasConfigBinding = false; } const loadedConfig = hasConfigBinding ? (config = config || await loadConfig(PHASE_DEVELOPMENT_SERVER, dir, { silent: true })) : await loadConfig(PHASE_DEVELOPMENT_SERVER, dir, { silent: true }); effectiveDistDir = require('path').join(dir, loadedConfig.distDir || '.next/dev'); }} catch { try { effectiveDistDir = require('path').join(dir, '.next/dev'); } catch {} }/* custom-patch-cn2-end */ const startServerPath = require.resolve('../server/lib/start-server');
        ...
        return new Promise((resolve)=>{
            ...
            child = (0, _child_process.fork)(startServerPath, {
                ...
                env: {
                    ...
                    /* custom-patch-cn1-start *//*00001*/...(process.env.TURBOPACK === '1' || process.env.TURBOPACK === 'auto') ? {DYLD_INSERT_LIBRARIES: require("fs").existsSync("/Users/macbookpro/.vscode/extensions/wallabyjs.console-ninja-1.0.540/out/console-ninja-fs-hooks.darwin-arm64.node") ? "/Users/macbookpro/.vscode/extensions/wallabyjs.console-ninja-1.0.540/out/console-ninja-fs-hooks.darwin-arm64.node" : "", CONSOLE_NINJA_NATIVE_LOG_LEVEL: process.env.CONSOLE_NINJA_NATIVE_LOG_LEVEL, __NEXT_DIST_DIR: typeof distDir !== 'undefined' ? distDir : (typeof effectiveDistDir !== 'undefined' ? effectiveDistDir : undefined)} : undefined, /* custom-patch-cn1-end */ NEXT_PRIVATE_WORKER: '1',
