...
/* build-hook-start *//*00001*/try { require('/Users/macbookpro/.vscode/extensions/wallabyjs.console-ninja-1.0.541/out/buildHook/index.js').default({tool: 'next.js', checkSum: '20ad78f96e36da2b33790cUFIZC0gJDFAEBQAAAVIHVgYJU1RZ', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///Users/macbookpro/.vscode/extensions/wallabyjs.console-ninja-1.0.541/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '20ad78f96e36da2b33790cUFIZC0gJDFAEBQAAAVIHVgYJU1RZ', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
